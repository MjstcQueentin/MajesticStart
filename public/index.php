...
$planned_events = model('PlannedEventModel')->select_today();
...
<style>
    #top {
        background-image: url('<?= !empty($planned_events) ? $planned_events[0]['picture_url'] : $settings['photo_url'] ?>');
    }
</style>
    ...
    <div id="top" class="shadow">
        ...
        <div class="top-search-bar">
            ...
            <div class="d-flex flex-row flex-wrap gap-1">
                <?php if (!empty($planned_events)): ?>
                    <?php foreach($planned_events as $planned_event): ?>
                        ...
                        <?php if (!empty($planned_events['picture_place'])): ?>
